...
begin
    ...
    insert into item(item_name, description, for_battle, for_food, for_water, for_care, for_health, price, img_url) 
    values
    ...
    insert into pet_type_move(move_id, pet_type_id) 
	values
		(1,1),
		(1,2),
		(1,3),
	...
	insert into user(username, password_hash, gold) 
    values
